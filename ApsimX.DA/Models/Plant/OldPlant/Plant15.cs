...
namespace Models.PMF.OldPlant
{
    ...
    public class Plant15 : ModelCollectionFromResource, ICrop, IUptake
    {
        ...
        /// <summary>Yuxi: Cultivar parameter Sens.</summary>
        [Link(IsOptional = true)]
        CultivarSens CultivarSens = null;
        ...
        public void Sow(string cultivar, double population, double depth, double rowSpacing, double maxCover = 1, double budNumber = 1)
        {
            ...
            if (CultivarSens != null&& CultivarSens.Commands != null)
            {
                    cultivarDefinition.UpdateApply(this, CultivarSens.Commands);
            }
        ...
        /// <param name="soilstate">soil state</param>
        /// <returns></returns>
        public List<ZoneWaterAndN> GetNUptakes(SoilState soilstate)     //Yuxi: Nitrogen uptake here.
        {
            if (IsAlive)
            {
                List<ZoneWaterAndN> Uptakes = new List<ZoneWaterAndN>();

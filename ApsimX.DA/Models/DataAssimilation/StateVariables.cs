        ...
        public double GetFromApsim(string tableName)
        {
            ...
            switch (tableName)
            {
                ...
                case "RootWt":
                    ...
                    break;
                case "Biomass":
                    value = GetBiomass(Leaf.Live, "Wt") + GetBiomass(Stem.Live, "Wt") + GetBiomass(Pod.Live, "Wt") + GetBiomass(Grain.Live, "Wt");
                    break;
                case "BiomassN":
                    value = GetBiomass(Leaf.Live, "N") + GetBiomass(Stem.Live, "N") + GetBiomass(Pod.Live, "N") + GetBiomass(Grain.Live, "N");
                    break;
                case "HeadWt":
                    value = GetBiomass(Pod.Live, "Wt") + GetBiomass(Grain.Live, "Wt");
                    break;
                case "HeadN":
                    value = GetBiomass(Pod.Live, "N") + GetBiomass(Grain.Live, "N");
                    break;
                case "SoilNTotal_1":
                    value = SoilNitrogen.NO3[0] + SoilNitrogen.NH4[0];
                    break;
                case "SoilNTotal_2":
                    value = SoilNitrogen.NO3[1] + SoilNitrogen.NH4[1];
                    break;
                case "SoilNTotal_3":
                    value = SoilNitrogen.NO3[2] + SoilNitrogen.NH4[2];
                    break;
                case "SoilNTotal_4":
                    value = SoilNitrogen.NO3[3] + SoilNitrogen.NH4[3];
                    break;
                case "SoilNTotal_5":
                    value = SoilNitrogen.NO3[4] + SoilNitrogen.NH4[4];
                    break;
                case "SoilNTotal_6":
                    value = SoilNitrogen.NO3[5] + SoilNitrogen.NH4[5];
                    break;
                case "SoilNTotal_7":
                    value = SoilNitrogen.NO3[6] + SoilNitrogen.NH4[6];
                    break;
                default:
                    {
                        value = -99;

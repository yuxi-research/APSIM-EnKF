...
namespace Models.Core
{
    ...
    public class Model : IModel
    {
        ...
        // Data assimilation
        [XmlElement(typeof(Models.DataAssimilation.DataAssimilation))]
        [XmlElement(typeof(Models.DataAssimilation.Control))]
        [XmlElement(typeof(Models.DataAssimilation.OpenLoop))]
        [XmlElement(typeof(Models.DataAssimilation.DirectInsertion))]
        [XmlElement(typeof(Models.DataAssimilation.EnKF))]
        [XmlElement(typeof(Models.DataAssimilation.StateVariables))]
        [XmlElement(typeof(Models.DataAssimilation.Observations))]
        [XmlElement(typeof(Models.DataAssimilation.InitialConditions))]

        //Sensitivity analysis
        [XmlElement(typeof(Models.Sensitivity.WeatherSens))]
        [XmlElement(typeof(Models.Sensitivity.CultivarSens))]
        [XmlElement(typeof(Models.Sensitivity.StateSens))]
        [XmlElement(typeof(Models.Sensitivity.SoilTemperatureSens))]
        [XmlElement(typeof(Models.Sensitivity.BiomassSens))]
        [XmlElement(typeof(Models.Sensitivity.LeafNodeSens))]
        [XmlElement(typeof(Models.Sensitivity.ThermalTimeSens))]

...
namespace UserInterface.Presenters
{
    ...
    public class MainPresenter
    {
        ...
        private void PopulateStartPage(IListButtonView startPage)
        {
            ...
            startPage.AddButton("Open Yuxi's toolbox",
                                        new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.Toolboxes.Toolbox.png")),
                                        OnYuxisToolboxClick);
        ...
        {
            Stream s = Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.Toolboxes.StandardToolboxTEST.apsimx");
        ...
        /// <summary>Event handler invoked when user clicks on 'Yuxi's toolbox'</summary>
        /// <param name="sender">Sender object</param>
        /// <param name="e">Event arguments</param>
        public void OnYuxisToolboxClick(object sender, EventArgs e)
        {
            Stream s = Assembly.GetExecutingAssembly().GetManifestResourceStream("UserInterface.Resources.Toolboxes.YuxisToolbox.apsimx");
            StreamReader streamReader = new StreamReader(s);
            bool onLeftTabControl = true;
            if (sender != null)
                onLeftTabControl = this.view.IsControlOnLeft(sender);

            this.OpenApsimXFromMemoryInTab("Yuxi's toolbox", streamReader.ReadToEnd(), onLeftTabControl);
        }
